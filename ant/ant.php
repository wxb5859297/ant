...
require $path . '/antconst.php'; //ant常量
require $path . '/ante.php'; //ant异常模块
require $path . '/antl.php'; //ant加载器
require $path . '/antc.php'; //ant控制器
require $path . '/antp.php'; //ant目标加载器
require $path . '/antr.php'; //ant请求过滤器
//require $path . '/antd.php'; //todo ant驱动器
//require $path . '/antcache.php'; //todo ant缓存器
...
class ant
{
     ...
     * @param $rs 资源定位
     * @param $act 资源控制
     * @param array $display_param 绑定的参数
